...
Time::Time(int absSecond)
{
	m_absSecond = absSecond > 0 ? absSecond : 0;
}

Time::Time(const Time &clock)
{
	m_absSecond = clock.m_absSecond;
}

// lay gio phut giay
int Time::getHour() const
{
	return m_absSecond / 3600;
}

int Time::getMinute() const
{
	return (m_absSecond / 60) % 60;
}

int Time::getSecond() const
{
	return m_absSecond % 60;
}
