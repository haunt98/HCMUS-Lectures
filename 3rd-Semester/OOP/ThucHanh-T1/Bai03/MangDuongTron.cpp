...
MangDuongTron::~MangDuongTron() { delete[] this->m_arr; }

bool MangDuongTron::nhohon(double a, double b) { return a <= b; }

bool MangDuongTron::lonhon(double a, double b) { return a >= b; }
