...
char *HocSinh::layTen() { return this->m_Ten; }

float HocSinh::layDiemVan() { return this->m_DiemVan; }

float HocSinh::layDiemToan() { return this->m_DiemToan; }

float HocSinh::layDiemTB() { return (this->m_DiemVan + this->m_DiemToan) / 2; }
