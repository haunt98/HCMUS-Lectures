...
int main()
{
	...
	SortAlgorithm<float> *alg1 = SortAlgorithm<float>::getObject(
	    SortAlgorithm<float>::InterchangeSort);
	SortAlgorithm<char> *alg2 = SortAlgorithm<char>::getObject(
	    SortAlgorithm<char>::InterchangeSort);
